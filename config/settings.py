...
DATABASES = {
    'default': {
        ...
        'NAME': env('DATABASE_NAME', default='wholesale_db'),
...
SESSION_COOKIE_SECURE = False  # Enable when SSL is configured
SESSION_COOKIE_HTTPONLY = True
SESSION_COOKIE_SAMESITE = 'Lax'

# CSRF Configuration
CSRF_COOKIE_SECURE = False  # Enable when SSL is configured
